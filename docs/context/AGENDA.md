...
### 제출물 (2026-09-04 공고문 재확인 — 접수와 본선이 다릅니다)

> ⚠️ 공고문 요약에 있던 「기능명세서」는 **데이콘 양식에 없습니다** (2026-09-06 직접 확인) — 접수는 기획서 + 웹서비스 주소 둘입니다.

| 무엇 | 언제 | 어떻게 |
| --- | --- | --- |
| 공모전 기획서 | **접수 — ~9/7(월) 10:00** | 데이콘 홈페이지 제공 양식 |
| **웹서비스 주소** | **접수 — ~9/7(월) 10:00** | **배포까지 마쳐야 함** |
| 소스코드 | 본선 진출자만 — 9/23(수)~10/8(목) | |
| 발표자료 | 본선 진출자만 — 9/23(수)~10/8(목) | |

남은 작업 목록은 [제출 핸드오프](../plans/09-04-submission-handoff.md)에 있습니다.
...
- [x] **접수 마감 — 2026년 9월 7일(월) 10:00** (2026-08-18 확인 · 2026-09-04 시각까지 확정)
- [x] **예선/본선 일정** (2026-09-04 공고문 재확인) — 본선 심사 대상 발표 9/22(화) ·
      소스코드·발표자료 제출 9/23~10/8 · 발표 심사(오프라인) 10/13(화) · 수상자 발표 10/23(금)
- [ ] 팀 구성 요건 (인원 상한, 자격 제한)
...
- [x] **첫 화면 구현** — `S-04` 랜딩 (`/`). 목업의 구조·간격을 그대로 옮김
- [ ] 구현 착수 · 배포
