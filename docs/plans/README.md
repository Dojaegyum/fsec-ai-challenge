...
| [09-06-kb-review-screen.md](09-06-kb-review-screen.md) | **KB 검수 큐 화면(S-12)** — 태스크 13개. 해시·껍데기 헤더·로그인·에러 코드·조문↔매뉴얼 규칙·`listEntries`·흐름·라우트 5·클라이언트·화면·문서 동기화·배포. 정본은 [ADR-081](../../decisions/081-kb-review-screen.md) |
