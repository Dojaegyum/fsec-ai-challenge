...
| `referenced_steps`·`referenced_deadlines` 용도 | api-routes :356 · system-prompt :314 · chat-context §5 | 항상 `[]`(`chat-turn.ts:88-92`) | 정본 지정 → 4절 |
