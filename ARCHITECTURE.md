...
- ⛔ **아직 아무것도 안 지워집니다** (2026-08-27 확인). 모듈은 서 있는데
  **깨우는 크론이 없습니다** — `vercel.json` 에 크론 항목이 없고 파기 라우트도
  안 붙었습니다. **「180일 뒤 지웁니다」는 지금 코드로 지켜지지 않는 약속입니다.**
  QA 범위에서 뺀 것은 사람 결정이지만(2026-08-27), **모르고 빠진 것이 아니라
  알고 미룬 것**으로 남깁니다 → [08-23-qa-readiness.md](docs/plans/08-23-qa-readiness.md) Task 7
