...
| [031](031-consent-clause-ack.md) | 동의 전문의 조항별 확인을 동의의 성립 요건으로 둔다 | 부분 대체됨(→074) |
...
| [074](074-consent-check-all.md) | 동의 조항 다섯을 「전부 확인」 한 번으로 채울 수 있게 한다 — 조항별 확인은 남기고, 동의 단추는 따로 둔다 | 채택 |
...
| [077](077-upload-is-not-proof.md) | 올린 파일은 증빙이 아니다 — L2 는 판독 결과에 접수번호 자리나 공공기관 이름이 있을 때만 통과하고, 끝난 단계의 기한은 닫는다 | 채택 |
...
| [085](085-shared-rate-counter.md) | 속도 제한 카운터는 Postgres 표에 센다 — 인스턴스마다 따로 세는 메모리 카운터를 대체 | 채택 |
| [086](086-defer-llm-work-after-read.md) | 판독 수거 요청은 마스킹·저장·판정까지만 하고, 기관명 보정과 슬롯 추출은 응답 뒤에 돈다 | 채택 |
| [087](087-statement-slot-extraction.md) | 자유 진술에서도 슬롯을 뽑는다 — 자료와 같은 추출기·같은 되묻기, `source_ref` 는 메시지 번호이고 추출은 응답 뒤에 돈다 | 채택 |
