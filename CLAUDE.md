...
| 코드 | `src/` | 도메인 모듈 32(`src/modules/` · 이름 33 중 `doc-filler` 는 [ADR-064](decisions/064-doc-filler-retired.md)로 폐기) · API 라우트 16(사건 13 + 크론 3) · 흐름(`src/flows/`) · 마이그레이션 0001~0010. 스캐폴딩 단계는 지났습니다 |
