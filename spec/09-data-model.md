...
CREATE TABLE message (
  ...
  kb_context_refs JSON        NULL
                              COMMENT '이 턴 프롬프트에 넣은 KB 항목의 식별자만.
                                       ...
                                       본문을 저장하지 않는다 → §9.1',
  citations      JSON         NULL COMMENT 'KB 인용 목록 (kb_entry_id·version·url)',
...
**`citations`는 절차를 언급한 응답에서 비면 안 됩니다.** `CLAUDE.md` 불변 규칙 1의 인용 강제를 저장 계층에서도 확인합니다.

**절차를 언급하지 않은 응답은 비어도 됩니다.** KB 조회 결과가 0건일 때가 그렇습니다 → [10-errors.md](10-errors.md) §4.1
