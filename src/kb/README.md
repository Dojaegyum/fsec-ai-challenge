...
`org.json`(기관 마스터)도 아직 없습니다. [research/04](../../docs/research/04-기관정보.md)에
공통 창구 넷과 은행 일곱의 사고신고 전화가 확인돼 있어 **그만큼은 쓸 수 있습니다** —
비어 있는 것은 앱 제출 경로와 간편송금·증권·가상자산·통신사·상품권 쪽입니다.
