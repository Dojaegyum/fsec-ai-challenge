...
import { isCronCall } from '@/lib/cron-call'
...
// 크론 호출 판정은 [lib/cron-call.ts](./lib/cron-call.ts) 로 옮겼습니다 —
// 요청 껍데기(`lib/request.ts`)의 두 번째 관문이 **같은 판단**을 써야 해서입니다.
// 여기 사본을 남기면 둘이 어긋나는 순간 그 틈으로 인증 없이 들어옵니다
