 ...
 *
 * 정본 §1.3 이 그렇게 정했습니다(2026-08-21). `KV_URL` 이 설정돼 있으면 거기서
 * 세고, 없으면 프로세스 메모리에 셉니다.
 *
 ...
 *
 * ⬜ **공유 구현이 아직 없습니다.** 볼트 제품이 미결이라(ADR-016 「남은 것」)
 * `KV_URL` 로 붙을 것이 정해지지 않았습니다. 계약은 여기 있고 구현만 없습니다.
 */
