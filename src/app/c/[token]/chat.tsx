...
/**
 * 미니 챗 — 본문이 플랜·증거함·기재 안내일 때 **오른쪽 열을 통째로** 쓰는 대응 비서.
 *
 * **챗은 늘 오른쪽에 삽니다** (2026-09-03 사용자 확정) — 본문일 땐 넓게,
 * 아닐 땐 이 열로 줄어들 뿐입니다. 챗 단독인 열이라 위아래 경계 상자가 없고,
...
export function MiniChat({
  ...
  // 열 하나를 통째로 쓰므로 **전부** 보여줍니다 — 자를 이유가 없어졌습니다
  // (전에는 오른쪽 열 한 칸이라 최근 넷만 잘랐습니다)
  const recent = lines;
