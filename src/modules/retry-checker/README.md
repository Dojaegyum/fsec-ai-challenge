...
| 무엇 | 어떻게 | 왜 |
| --- | --- | --- |
| **정책 표에 없는 예외** | **재시도하지 않는다** | 기본값을 지어내면 근거 없는 동작이 조용히 생깁니다. 멈추고 `no_policy` 를 남기면 무엇을 빠뜨렸는지 드러납니다 |
| **전체 예산 계산** | **대기 시간을 더해서 잰다** | 더하지 않으면 19.9초에 3초를 기다린 뒤 불러 23초가 됩니다. 정본의 「20초」 의도와 어긋납니다 |
